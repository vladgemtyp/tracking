...
class StatusProcessingButton extends GenericButton implements ButtonProviderInterface
{
    /**
     * @return array|void
    ...
    public function getButtonData()
    {
        if ($this->getRoute() && $this->routeIsComplete()) {
            return [
                'id' => 'prccessing',
                'label' => __('Processing'),
                'on_click' => "deleteConfirm('" .__('Are you sure you want return this route to process?') ."', '"
                    . $this->getUrl('*/*/processing', ['id' => $this->getRoute()]) . "', {data: {}})",
